...
date: "![](img/slides.png){width=5%} [cmjt.github.io/slides/latent](https://cmjt.github.io/slides/latent)"
header-includes:
   - \usepackage{xcolor}
   - \usepackage{amsmath}
   - \usepackage{animate}
...
<br>
<br>
.center[`r icon::fa("twitter")` @cmjonestodd]
<br>
.center[`r icon::fa("github")` @cmjt]
<br>
.center[<i class="fas fa-images"></i>  [cmjt.github.io/slides/latent](https://cmjt.github.io/slides/latent)]
]
